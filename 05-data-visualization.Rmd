...
## Histogram
Another way to visualize the distribution of genome sizes is to use a histogram, which we can do using the `hist` function:
...
```{r, fig.align='center'}
ggplot(metadata) +
  geom_histogram(aes(x = genome_size), stat = "bin", binwidth=0.05)
