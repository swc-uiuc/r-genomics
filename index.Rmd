...
in working with genomics data in R. If you had just gotten used to shell /
biocluster, use this handy [comparison between Linux and R](Linux_R_Comp.pdf).
...
how to install and manage packages, and ways to get more practice learning R.
